...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('products')->insert([
            ...
            ['name' => 'Pizza Caprese', 'category' => "vegeterian",  'ingredientString' => 'Tomato sauce, mozzarella, tomatoes, basil', 'allergyString' => 'Gluten, lactose', 'picture' => 'productPictures/2.png', 'business_id' => 1],
            ['name' => 'Pepperoni Pizza', 'category' => "Non-vegetarian",  'ingredientString' => 'Tomato sauce, mozzarella, pepperoni', 'allergyString' => 'Gluten, lactose', 'picture' => 'productPictures/3.png', 'business_id' => 1],
