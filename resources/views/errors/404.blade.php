...
<style>
    #toast-background {
        background-image: url('../images/backgroundDots.svg');
    ...
    <div class="ag-page-404">
        <h3 style="text-align: center;padding-top:20px;">Ops, page not found :'(</h3>
            ...
            $(function() {
                ...
                $().ready(function() {
                    ...
                    function render() {
                        ...
                        while (len--)
                            if (parts[len].y < 0 || parts[len].lifeTime > maxLifeTime) {
                                ...
                                ctx.drawImage(smokeImage, offsetX, offsetY, parts[len].size, parts[
                                    len].size);
                                ctx.restore()
                            }
                        spawn();
                    ...
                    smoke.prototype.update = function() {
                        ...
                        this.size = this.startSize + ((this.endSize - this.startSize) *
                            lifePerc * .1);
